  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-xl text-white">Use Case Owners</h3>
          ...
          >
            <div className="flex items-start mb-4">
              ...
              <div className="flex-1">
                <h4 className="text-white mb-1">{owner.name}</h4>
            ...
            <div className="pt-3 border-t border-white/10">
              <div className="flex items-center justify-between text-xs text-slate-400">
                <span>Role</span>
                <span className="px-2 py-1 bg-blue-500/20 text-blue-400 border border-blue-500/30 rounded-full">
                  {owner.role}
                </span>
              </div>
            </div>
      ...
      {owners.length === 0 && (
        <div className="text-center py-12 text-slate-500">
          <UserIcon className="h-16 w-16 text-slate-600 mx-auto mb-3" />
          <p className="mb-2">
