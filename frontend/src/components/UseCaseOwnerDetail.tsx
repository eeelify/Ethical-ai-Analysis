    ...
    <div className="min-h-screen bg-[#050b14]">
      ...
      <div className="px-6 py-6 max-w-5xl mx-auto">
        ...
        <div className="bg-[#0b1221] rounded-lg shadow-[0_0_15px_rgba(0,0,0,0.5)] border p-6 mb-6">
          <div className="flex items-start">
            ...
            <div className="flex-1">
              <h1 className="text-2xl text-white mb-2">{owner.name}</h1>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="flex items-start">
                  <Mail className="h-5 w-5 text-gray-400 mr-2 mt-0.5" />
                  <div>
                    <div className="text-xs text-slate-500">Email</div>
                    <div className="text-sm text-white">{owner.email}</div>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white">{owner.role}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-[#0b1221] rounded-lg shadow-[0_0_15px_rgba(0,0,0,0.5)] border p-6">
          <h2 className="text-xl text-white mb-6">Owned Use Cases</h2>
          ...
          {loading ? (
            <div className="text-center py-12 text-slate-500">Loading use cases...</div>
          ) : useCases.length > 0 ? (
                ...
                <div key={uc.id} className="border rounded-lg p-4">
                  <div className="flex items-start justify-between">
                    <div className="min-w-0">
                      <div className="text-sm text-slate-500 mb-1">Use Case</div>
                      <div className="text-lg text-white truncate">{uc.title}</div>
                    ...
                    {onViewUseCase && (
                      <button
                        ...
                        className="ml-4 inline-flex items-center px-3 py-2 text-sm border border-white/10 rounded-lg hover:bg-[#050b14]"
                      >
